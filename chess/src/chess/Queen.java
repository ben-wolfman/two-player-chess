...
public class Queen extends Piece {
	...
	public Queen(String n, Spot p, String c) {
		super(n, p, c);
	}
	...
	public boolean canMove(Board board, Spot start, Spot end) {
		...
		if ((Math.abs(end.getY()-start.getY()) == Math.abs(end.getX()-start.getX())) || ((Math.abs(end.getY()-start.getY()) == 0 && Math.abs(end.getX()-start.getX()) != 0)) || ((Math.abs(end.getY()-start.getY()) != 0 && Math.abs(end.getX()-start.getX()) == 0))) {
			dir = true;
		}
		else {
			dir = false;
